export type Course = { id: string; code: string; title: string; instructor: string; credits: number; attendedClasses: number; totalClasses: number; attendanceThreshold: number; };
